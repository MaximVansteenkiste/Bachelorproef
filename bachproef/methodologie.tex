...
\begin{table}[]
    ...
    \begin{tabular}{@{}lrrrr@{}}
    \toprule
                                                                                                  & \multicolumn{1}{l}{\textbf{Nieuw project}} & \multicolumn{1}{l}{\textbf{Mortage}} & \multicolumn{1}{l}{\textbf{ToDoist}} & \multicolumn{1}{l}{\textbf{Bar}} \\ \midrule
    \textbf{Grootte project (MB)}                                                                 & 0,037                                      & 0,017                                & 0,106                                & 26,6                             \\
    \textbf{Grootte node\_modules (MB)}                                                           & 214,1                                      & 231                                  & 376,6                                & 442,4                            \\
    \textbf{Grootte uitvoer (MB)}                                                                 & 0,514                                      & 0,892                                & 3,9                                  & 33,9                             \\
    \textbf{Snelheid creatie uitvoer (s)}                                                         & 3,67                                       & 4,67                                 & 6,33                                 & 13,67                            \\
    \multicolumn{1}{r}{1}                                                                         & 5                                          & 7                                    & 10                                   & 21                               \\
    \multicolumn{1}{r}{2}                                                                         & 3                                          & 3                                    & 5                                    & 10                               \\
    \multicolumn{1}{r}{3}                                                                         & 3                                          & 4                                    & 4                                    & 10                               \\
    \textbf{\begin{tabular}[c]{@{}l@{}}Snelheid opstarten \\ development server (s)\end{tabular}} & 2,67                                       & 3,67                                 & 4,00                                 & 8,67                             \\
